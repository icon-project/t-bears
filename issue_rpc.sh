...
case "$action" in
  ...
  tokenbal|tokenBalance )
      PARAMS='{"jsonrpc": "2.0", "method": "icx_call", "id": 50889, "params": { "from": "hx0000000000000000000000000000000000000000", "to": "cxb8f2c9ba48856df2e889d1ee30ff6d2e002651cf", "dataType": "call", "data": {"method": "balance_of", "params": {"addr_from": "hx1111111111111111111111111111111111111111"}}}}'
  ;;
  tokensup|tokenTotalSupply )
      PARAMS='{"jsonrpc": "2.0", "method": "icx_call", "id": 60889, "params": { "from": "hx0000000000000000000000000000000000000000", "to": "cxb8f2c9ba48856df2e889d1ee30ff6d2e002651cf", "dataType": "call", "data": {"method": "total_supply", "params": {}}}}'
  ;;
  seq1 )
